...
MODULE = "devcovenant.core.run_events"
PACKAGE_MODULES = ("devcovenant.core",)
SUBMODULE_IMPORTS = (
    "devcovenant.core.gate_runtime",
    "devcovenant.core.execution",
    "devcovenant.core.run_events",
...
def _unit_test_core_modules_do_not_define_dynamic_getattr() -> None:
    """Flat core modules should not rely on lazy package-level hooks."""
...
class RunEventsTests(unittest.TestCase):
    ...
    def test_core_modules_do_not_define_dynamic_getattr(self):
        """Run flat-core no-`__getattr__` assertions."""
        _unit_test_core_modules_do_not_define_dynamic_getattr()
