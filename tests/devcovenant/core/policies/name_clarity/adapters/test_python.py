"""Unit tests for the Python name clarity adapter."""

import unittest
from pathlib import Path

from devcovenant.core.policies.name_clarity.adapters import python as adapter
...
class GeneratedUnittestCases(unittest.TestCase):
    ...
    def test_honors_allow_comment(self):
        ...
        source = "tmp = 1  # name-clarity: allow\n"
        violations = adapter.check_file(
            path=Path("worker.py"),
            source=source,
            policy_id="name-clarity",
