"""Tests for devcovenant.core.policy_runtime_actions."""
...
MODULE = "devcovenant.core.policy_runtime_actions"


def _runtime_action_module_importable() -> None:
    """Module should import cleanly."""
    module = importlib.import_module(MODULE)
    assert module is not None


def _runtime_action_symbol_contract_is_stable() -> None:
...
def _runtime_action_symbol_assertions_cover_runtime_action_seam() -> None:
...
def _runtime_action_load_policy_check_instance_returns_none_when_missing() -> (
    None
):
...
def _runtime_action_runtime_policy_config_overrides_reads_config() -> None:
...
def _runtime_action_build_runtime_policy_option_views_prefers_overrides() -> (
    None
):
...
def _runtime_action_metadata_decodes_registry_strings() -> None:
...
def _runtime_action_runtime_policy_metadata_prefers_typed_registry() -> None:
...
def _runtime_action_runtime_action_dispatches_with_injected_loaders() -> None:
...
def _runtime_action_run_policy_runtime_action_fails_when_policy_missing() -> (
    None
):
...
class PolicyRuntimeActionsTests(unittest.TestCase):
    ...
    def test_run_policy_runtime_action_dispatches_with_injected_loaders(self):
        ...
        _runtime_action_runtime_action_dispatches_with_injected_loaders()

    def test_run_policy_runtime_action_fails_when_policy_missing(self):
        """Run runtime-action missing-policy assertions."""
        _runtime_action_run_policy_runtime_action_fails_when_policy_missing()
