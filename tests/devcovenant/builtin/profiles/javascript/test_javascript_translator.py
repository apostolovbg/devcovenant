"""Unit tests for the JavaScript language translator."""
...
def _load_translator_module():
    ...
    spec = importlib.util.spec_from_file_location(
        "javascript_translator", _TRANSLATOR_PATH
    )
...
def _declaration() -> TranslatorDeclaration:
    ...
    return TranslatorDeclaration(
        translator_id="javascript",
        profile_name="javascript",
        extensions=(".js",),
        can_handle_strategy="module_function",
        can_handle_entrypoint="javascript_translator.py:can_handle",
        translate_strategy="module_function",
        translate_entrypoint="javascript_translator.py:translate",
    )


class JavascriptTranslatorTests(unittest.TestCase):
    """Verify JavaScript translation behavior."""
    ...
    def test_can_handle_suffix(self):
        ...
        self.assertTrue(
            module.can_handle(
                path=Path("sample.js"), declaration=_declaration()
            )
        )
