...
_TRANSLATOR_PATH = (
    _REPO_ROOT / "devcovenant/builtin/profiles/csharp/csharp_translator.py"
)
...
def _declaration() -> TranslatorDeclaration:
    ...
    return TranslatorDeclaration(
        ...
        can_handle_entrypoint="csharp_translator.py:can_handle",
        translate_strategy="module_function",
        translate_entrypoint="csharp_translator.py:translate",
    )
