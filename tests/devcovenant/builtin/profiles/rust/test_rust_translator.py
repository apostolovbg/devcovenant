...
_TRANSLATOR_PATH = (
    _REPO_ROOT / "devcovenant/builtin/profiles/rust/rust_translator.py"
)
...
def _declaration() -> TranslatorDeclaration:
    ...
    return TranslatorDeclaration(
        ...
        can_handle_entrypoint="rust_translator.py:can_handle",
        translate_strategy="module_function",
        translate_entrypoint="rust_translator.py:translate",
    )
