...
- 2026-04-15:
  ...
  Why: Clarified that every gate invocation is a command while preserving
  flag syntax, and aligned the full changelog with the documented blank-line
  layout.
  Impact: Users follow `gate --open -> gate --verify -> run -> gate --close`,
  generated docs and workflows use the renamed lifecycle, and old changelog
  entries match the same spacing contract as new entries.
  Files:
  CHANGELOG.md
  ...
  tests/devcovenant/core/test_run_logs.py
  tests/devcovenant/core/test_workflow_support.py
...
- 2026-04-02:
  ...
  Why: removed merge-history residue, kept the flat core surface readable, and
       clarified docs without time-bound or repo-bound phrasing.
  Impact: reviewers read the current architecture directly, mirrored core
          tests stay coherent, and public docs avoid stale wording drift.
  Files:
  CHANGELOG.md
  devcovenant/core/cleanup.py
...
- 2026-04-02:
  Change: restructured the flat core module surface, removed lingering
          split-era mirrored-test paths, and aligned the active
          policy/runtime/docs surfaces around the current forward-only
          baseline.
  Why: removed staged-path drift, enforced the in-scope mirrored-test
       contract, and reconciled the broader flat-core slice with the remaining
       old-path cleanup the gate was still tracking.
  Impact: stabilized changelog coverage for the full current slice, prevented
          split-brained path accounting, and prepared the workflow to continue
  ...
  devcovenant/builtin/policies/line_length_limit/line_length_limit.py
  devcovenant/builtin/policies/managed_environment/\
    managed_environment_runtime.py
  devcovenant/builtin/policies/modules_need_tests/modules_need_tests.py
  devcovenant/builtin/policies/name_clarity/name_clarity.py
  devcovenant/builtin/policies/no_print_outside_output_runtime/\
  ...
  devcovenant/builtin/policies/read_only_directories/read_only_directories.py
  devcovenant/builtin/policies/security_scanner/security_scanner.py
  ...
  tests/devcovenant/core/test_agents_blocks.py
  tests/devcovenant/core/test_asset_materialization.py
  tests/devcovenant/core/test_cleanup.py
  tests/devcovenant/core/test_cli_support.py
  tests/devcovenant/core/test_document_exemptions.py
  tests/devcovenant/core/test_execution.py
  tests/devcovenant/core/test_gate_runtime.py
  tests/devcovenant/core/test_managed_docs.py
  tests/devcovenant/core/test_policy_autofix.py
  tests/devcovenant/core/test_policy_commands.py
  tests/devcovenant/core/test_policy_contract.py
  tests/devcovenant/core/test_policy_metadata.py
  tests/devcovenant/core/test_policy_registry.py
  tests/devcovenant/core/test_policy_runtime.py
  tests/devcovenant/core/test_policy_runtime_actions.py
  tests/devcovenant/core/test_profile_registry.py
  tests/devcovenant/core/test_project_governance.py
  tests/devcovenant/core/test_refresh_runtime.py
  tests/devcovenant/core/test_repository_paths.py
  tests/devcovenant/core/test_repository_validation.py
  tests/devcovenant/core/test_run_events.py
  tests/devcovenant/core/test_run_logs.py
  tests/devcovenant/core/test_runtime_errors.py
  tests/devcovenant/core/test_runtime_profile.py
  tests/devcovenant/core/test_selectors.py
  tests/devcovenant/core/test_tracked_registry.py
  tests/devcovenant/core/test_translator.py
  tests/devcovenant/core/test_workflow_support.py
  ...
  tests/devcovenant/repo_seed_cache.py
  ...
  tests/devcovenant/test_undeploy.py
  tests/devcovenant/test_upgrade.py
  devcovenant/core/policy_support.py
  devcovenant/core/repo_validation.py
  devcovenant/core/repository_support.py
  devcovenant/licenses/THIRD_PARTY_LICENSES.md
  licenses/THIRD_PARTY_LICENSES.md
  tests/devcovenant/core/cleanup_cases_command.py
  tests/devcovenant/core/cli_support_cases_args.py
  tests/devcovenant/core/cli_support_cases_output.py
  tests/devcovenant/core/gate_runtime_cases_changelog.py
  tests/devcovenant/core/gate_runtime_cases_gate.py
  tests/devcovenant/core/gate_runtime_cases_session.py
  tests/devcovenant/core/gate_runtime_cases_snapshot.py
  tests/devcovenant/core/gate_runtime_cases_status.py
  tests/devcovenant/core/gate_runtime_cases_status_validation.py
  tests/devcovenant/core/gate_runtime_cases_workflow_session.py
  tests/devcovenant/core/policy_runtime_cases_check_context.py
  tests/devcovenant/core/policy_runtime_cases_check_runner.py
  tests/devcovenant/core/policy_runtime_cases_engine.py
  tests/devcovenant/core/policy_runtime_cases_file_scope.py
  tests/devcovenant/core/policy_runtime_cases_reporting.py
  tests/devcovenant/core/policy_support_cases_commands.py
  tests/devcovenant/core/policy_support_cases_metadata.py
  tests/devcovenant/core/policy_support_cases_parse.py
  tests/devcovenant/core/policy_support_cases_registry.py
  tests/devcovenant/core/policy_support_cases_runtime_actions.py
  tests/devcovenant/core/repo_validation_cases_integrity.py
  tests/devcovenant/core/repo_validation_cases_manifest.py
  tests/devcovenant/core/repo_validation_cases_structure.py
  tests/devcovenant/core/repository_support_cases_document_exemptions.py
  tests/devcovenant/core/repository_support_cases_profile_registry.py
  tests/devcovenant/core/repository_support_cases_project_governance.py
  tests/devcovenant/core/repository_support_cases_runtime_profile.py
  tests/devcovenant/core/repository_support_cases_selectors.py
  tests/devcovenant/core/repository_support_cases_tracked_registry.py
  tests/devcovenant/core/repository_support_cases_yaml_cache.py
  tests/devcovenant/core/runtime_errors_cases_contract.py
  tests/devcovenant/core/runtime_errors_cases_errors.py
  tests/devcovenant/core/test_policy_support.py
  tests/devcovenant/core/test_repo_validation.py
  tests/devcovenant/core/test_repository_support.py
  tests/devcovenant/core/workflow_support_cases_contract.py
  tests/devcovenant/core/workflow_support_cases_registry.py
  tests/devcovenant/core/workflow_support_cases_validation.py

- 2026-04-02:
  Change: restructured the flat core module surface, realigned the
    mirrored core tests, and prevented DevCovenant-owned source/test
    runs from writing repo-local bytecode under devcovenant/** and
    tests/devcovenant/**.
  Why: removed split-era engine ownership drift, preserved the
    forward-only test mirror contract after flattening core, and
    prevented DevCovenant-owned Python code from generating cache
    artifacts in the trees it owns.
  Impact: aligned the flat core/runtime surface with its mirrored
    tests, kept policy/gate orchestration pointed at the new module
    ownership model, and prevented DevCovenant source/test runs from
    leaving __pycache__ or compiled artifacts in owned trees.
  Files:
  .github/workflows/ci.yml
  AGENTS.md
  CHANGELOG.md
  ...
  devcovenant/builtin/policies/modules_need_tests/modules_need_tests.py
  devcovenant/builtin/policies/name_clarity/name_clarity.py
  devcovenant/builtin/policies/no_future_dates/autofix/global.py
  devcovenant/builtin/policies/no_future_dates/no_future_dates.py
  devcovenant/builtin/policies/no_print_outside_output_runtime/\
    no_print_outside_output_runtime.py
  devcovenant/builtin/policies/no_raw_errors/no_raw_errors.py
  devcovenant/builtin/policies/raw_string_escapes/autofix/global.py
  devcovenant/builtin/policies/raw_string_escapes/raw_string_escapes.py
  devcovenant/builtin/policies/read_only_directories/\
    read_only_directories.py
  devcovenant/builtin/policies/security_scanner/security_scanner.py
  devcovenant/builtin/policies/tests_coverage/assertion_signal.py
  devcovenant/builtin/policies/tests_coverage/tests_coverage.py
  devcovenant/builtin/policies/version_governance/custom_adapter.py
  ...
  devcovenant/builtin/policies/version_governance/version_governance.py
  devcovenant/builtin/policies/version_sync/version_sync.py
  devcovenant/builtin/profiles/csharp/csharp_translator.py
  devcovenant/builtin/profiles/dart/dart_translator.py
  devcovenant/builtin/profiles/go/go_translator.py
  devcovenant/builtin/profiles/java/java_translator.py
  devcovenant/builtin/profiles/javascript/javascript_translator.py
  ...
  devcovenant/builtin/profiles/php/php_translator.py
  devcovenant/builtin/profiles/python/python.yaml
  devcovenant/builtin/profiles/python/python_translator.py
  devcovenant/builtin/profiles/ruby/ruby_translator.py
  devcovenant/builtin/profiles/rust/rust_translator.py
  devcovenant/builtin/profiles/sql/sql_translator.py
  devcovenant/builtin/profiles/swift/swift_translator.py
  devcovenant/builtin/profiles/typescript/typescript_translator.py
  devcovenant/check.py
  devcovenant/clean.py
  devcovenant/cli.py
  devcovenant/config.yaml
  ...
  devcovenant/core/runtime/cli_args.py
  ...
  tests/devcovenant/builtin/policies/last_updated/test_last_updated.py
  tests/devcovenant/builtin/policies/line_length_limit/\
    test_line_length_limit.py
  tests/devcovenant/builtin/policies/managed_environment/\
    test_managed_environment.py
  tests/devcovenant/builtin/policies/modules_need_tests/\
    test_modules_need_tests.py
  tests/devcovenant/builtin/policies/name_clarity/test_name_clarity.py
  tests/devcovenant/builtin/policies/no_future_dates/autofix/test_global.py
  tests/devcovenant/builtin/policies/no_future_dates/test_no_future_dates.py
  ...
  tests/devcovenant/builtin/policies/raw_string_escapes/autofix/\
    test_global.py
  tests/devcovenant/builtin/policies/raw_string_escapes/\
    test_raw_string_escapes.py
  tests/devcovenant/builtin/policies/read_only_directories/\
  ...
  tests/devcovenant/builtin/policies/version_governance/\
    test_version_governance.py
  tests/devcovenant/builtin/policies/version_sync/test_version_sync.py
  tests/devcovenant/builtin/profiles/csharp/test_csharp_translator.py
  tests/devcovenant/builtin/profiles/dart/test_dart_translator.py
  tests/devcovenant/builtin/profiles/go/test_go_translator.py
  tests/devcovenant/builtin/profiles/java/test_java_translator.py
  tests/devcovenant/builtin/profiles/javascript/\
    test_javascript_translator.py
  tests/devcovenant/builtin/profiles/objective_c/\
    test_objective_c_translator.py
  tests/devcovenant/builtin/profiles/opencl/test_opencl_translator.py
  tests/devcovenant/builtin/profiles/php/test_php_translator.py
  tests/devcovenant/builtin/profiles/python/test_python_translator.py
  tests/devcovenant/builtin/profiles/ruby/test_ruby_translator.py
  tests/devcovenant/builtin/profiles/rust/test_rust_translator.py
  tests/devcovenant/builtin/profiles/sql/test_sql_translator.py
  tests/devcovenant/builtin/profiles/swift/test_swift_translator.py
  tests/devcovenant/builtin/profiles/typescript/\
    test_typescript_translator.py
  tests/devcovenant/core/cleanup_cases_command.py
  tests/devcovenant/core/cli_support_cases_args.py
  tests/devcovenant/core/cli_support_cases_output.py
  tests/devcovenant/core/contracts/__init__.py
  tests/devcovenant/core/contracts/test_errors.py
  tests/devcovenant/core/contracts/test_policy.py
  tests/devcovenant/core/flow/__init__.py
  ...
  tests/devcovenant/core/gate_runtime_cases_status_validation.py
  tests/devcovenant/core/gate_runtime_cases_workflow_session.py
  tests/devcovenant/core/lib/__init__.py
  ...
  tests/devcovenant/core/repository_support_cases_tracked_registry.py
  tests/devcovenant/core/repository_support_cases_yaml_cache.py
  tests/devcovenant/core/runtime/__init__.py
  tests/devcovenant/core/runtime/test_cli_args.py
  ...
  tests/devcovenant/core/runtime_errors_cases_contract.py
  tests/devcovenant/core/runtime_errors_cases_errors.py
  tests/devcovenant/core/services/__init__.py
...
- 2026-04-02:
  Change: fixed repo-relative dependency-registry fingerprints, removed
    command-layer compatibility shims in favor of lazy command/runtime
    loading, moved the version fast path onto a lightweight output boundary,
    and reduced Python policy overhead with lighter translation paths for
    doc/test coverage checks.
  Why: remove checkout-path drift in tracked registry state, cut startup
    overhead from commands that should stay lightweight, avoid reintroducing
    eager runtime imports just to print the version string, and reduce
    repeated AST-heavy work that still kept `check`, hooks, and integration
    tests slower than they should be.
  Impact: lightweight commands such as `--help`, `clean --help`, and
    `gate --status` return much faster, warmed DevCovenant hook runs stay
    comfortably below the long-wait threshold more often, tracked dependency
    fingerprints stay stable across different checkout roots, and the lazy
    CLI contract is now covered directly instead of preserved by compatibility
    globals.
  Files:
  CHANGELOG.md
  devcovenant/asset.py
