...
class ChangeState:
    ...
    Attributes:
        ...
        current_snapshot_paths: Changed paths in the current snapshot.
        current_snapshot_numstat: Numstat rows in the current snapshot.
        session_paths: Changed paths since gate start.
