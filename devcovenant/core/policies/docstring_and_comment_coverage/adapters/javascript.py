"""JavaScript/JSX adapter for doc/comment coverage."""
...
FUNCTION_PATTERNS = [
    ...
    re.compile(r"\bconst\s+([A-Za-z_][A-Za-z0-9_]*)\s*=\s*function\b"),
...
def check_file(path: Path, source: str, policy_id: str) -> List[Violation]:
    """Return violations for JS/JSX when declarations lack docs."""
