"""Shared managed/header exemption fingerprint helpers.

This module centralizes the changelog/session exemption fingerprint model
used by gate-session baseline capture and changelog-coverage validation.
"""
