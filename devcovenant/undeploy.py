"""Undeploy command implementation for DevCovenant."""
...
def _build_parser() -> argparse.ArgumentParser:
    ...
    parser = argparse.ArgumentParser(description="Remove deployed runtime.")
    return parser
...
def run(args: argparse.Namespace) -> int:
    ...
    print_banner("Undeploy DevCovenant", "🧽")

    undeploy_core.main(argv=["--target", str(repo_root)])
    return 0
